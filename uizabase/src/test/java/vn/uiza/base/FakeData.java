...
public class FakeData {
    ...
    public static CreateUser updateUser() {
        ...
        updateUser.setId("37d6706e-be91-463e-b3b3-b69451dd4752");
    ...
    public static CreateMetadata createMetadata() {
        ...
        createMetadata.setType("folder");
        createMetadata.setDescription("Folder description");
        createMetadata.setOrderNumber(1);
        createMetadata.setIcon("https://exemple.com/icon.png");
    ...
    public static ResultCreateMetadata resultCreateMetadata() {
        ...
        resultCreateMetadata.setVersion(3);
        ...
        resultCreateMetadata.setServiceName("api");
